...
public class JwtUtils {
	...
	private String privateKeyStr = SystemConfig.JWT_RSA_PRIVATEKEY;//私钥key
	
	private String pubicKeyStr = SystemConfig.JWT_RSA_PUBLICKEY;//公钥key
	...
	public static JwtUtils install(){
		if(null == jwtUtils){
			return new JwtUtils();
		}
		return jwtUtils;
