...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	// 格尼林治时间
	public static final SimpleDateFormat GNLZ = new SimpleDateFormat("yyyy-MM-dd'T'hh:mm:ss'.'sss'Z'");
	...
	public static void main(String[] args) {
		...
		String gnlz = parseDateToGNLZ(date);
//		String date = "2018-07-31T10:08:30.030Z"; 2018-07-31T04:31:40.040Z
		System.out.println("gnlz:" + gnlz);
		
		gnlz = "2018-07-28T04:31:40.040Z"; // 2018-07-28 12:31:40
		gnlz = "2018-07-31T04:31:40.040Z"; // 2018-07-31 12:31:40
		
		System.out.println(DateUtils.getTimeStampStr(parseGNLZToDate(gnlz)));
	...
	/**
	 * 将 时间 yyyy-MM-dd HH:mm:ss 转换成 格尼林治时间 2014-06-27T08:11:07.168Z
	 * 
	 */
	public static String parseDateToGNLZ(Date date) {
		try {
			return GNLZ.format(date);
		} catch (Exception e) {
	 ...
	 * 
	 */
	public static Date parseGNLZToDate(String date) {
		try {
	 ...
	 * 
	 */
	public static String getReqTimeDate(Date date) {
