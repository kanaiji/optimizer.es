...
public class SystemConfig {
	...
	private static void init(Properties props) {
		...
		if (StringUtils.isEmpty(gateway_url)) {
		...
		if (StringUtils.isEmpty(weixin_pay_app_id)) {
		...
		if (StringUtils.isEmpty(weixin_pay_app_secret)) {
		...
		if (StringUtils.isEmpty(weixin_pay_redirect_url)) {
		...
		if (StringUtils.isEmpty(weixin_gzh_app_id)) {
		...
		if (StringUtils.isEmpty(weixin_gzh_app_secret)) {
		...
		if (StringUtils.isEmpty(weixin_gzh_redirect_url)) {
		...
		if (StringUtils.isEmpty(weixin_gzh_templateId)) {
		...
		if (StringUtils.isEmpty(ftp_charset)) {
		...
		if (StringUtils.isEmpty(ftp_username)) {
		...
		if (StringUtils.isEmpty(ftp_password)) {
		...
		if (StringUtils.isEmpty(ftp_project)) {
		...
		if (StringUtils.isEmpty(ftp_dest_path)) {
		...
		if (StringUtils.isEmpty(sftp_charset)) {
		...
		if (StringUtils.isEmpty(sftp_host)) {
			SFTP_HOST = sftp_host;
		} else {
		...
		if (StringUtils.isEmpty(sftp_port)) {
		...
		if (StringUtils.isEmpty(sftp_username)) {
		...
		if (StringUtils.isEmpty(sftp_password)) {
		...
		if (StringUtils.isEmpty(sftp_project)) {
		...
		if (StringUtils.isEmpty(sftp_dest_path)) {
		...
		if (StringUtils.isEmpty(qrcode_charset)) {
		...
		if (StringUtils.isEmpty(qrcode_format)) {
		...
		if (StringUtils.isEmpty(qrcode_size)) {
		...
		if (StringUtils.isEmpty(qrcode_logo_width)) {
		...
		if (StringUtils.isEmpty(qrcode_logo_height)) {
		...
		if (StringUtils.isEmpty(qrcode_logo_path)) {
		...
		if (StringUtils.isEmpty(pay_result_notify_url)) {
		...
		if (StringUtils.isEmpty(pay_ali_p_id)) {
		...
		if (StringUtils.isEmpty(pay_ali_app_id)) {
		...
		if (StringUtils.isEmpty(pay_ali_wap_url)) {
		...
		if (StringUtils.isEmpty(pay_complete_url)) {
		...
		if (StringUtils.isEmpty(pay_result_order_query)) {
		...
		if (StringUtils.isEmpty(pay_result_return_url)) {
		...
		if (StringUtils.isEmpty(proxy_pay_result_notify_url)) {
		...
		if (StringUtils.isEmpty(reconciliation_file_dir)) {
		...
		if (StringUtils.isEmpty(reconciliation_download_dir)) {
		...
		if (StringUtils.isEmpty(jwt_rsa_privateKey)) {
		...
		if (StringUtils.isEmpty(jwt_rsa_publicKey)) {
		...
		if (StringUtils.isEmpty(alibaba_msg_url)) {
		...
		if (StringUtils.isEmpty(alibaba_app_key)) {
		...
		if (StringUtils.isEmpty(alibaba_app_secret)) {
		...
		if (StringUtils.isEmpty(alibaba_msg_template_id)) {
		...
		if (StringUtils.isEmpty(aliyun_sms_status)) {
		...
		if (StringUtils.isEmpty(aliyun_sms_key)) {
		...
		if (StringUtils.isEmpty(aliyun_sms_secret)) {
		...
		if (StringUtils.isEmpty(aliyun_sms_template_id)) {
		...
		try {
			...
			if (StringUtils.isEmpty(aliyun_sms_signname)) {
		...
		if (StringUtils.isEmpty(system_conditions)) {
		...
		if (StringUtils.isEmpty(system_owner)) {
		...
		if (StringUtils.isEmpty(system_jsp_style_version)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_master_ip)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_master_port)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_master_password)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_master_luasha)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_backup_ip)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_backup_port)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_backup_password)) {
		...
		if (StringUtils.isEmpty(id_generator_redis_backup_luasha)) {
